...
//-------------------------     моє рішення, валідатор не приймає
...
//                try
//                {
//                    readNum = Integer.parseInt((arr[i]));
//
//                    for(Map.Entry<Integer,String> nums : map.entrySet())
//                    {
//                        if(readNum == nums.getKey())
//                        {
//                            file = file.replaceAll(String.valueOf(readNum),nums.getValue());
