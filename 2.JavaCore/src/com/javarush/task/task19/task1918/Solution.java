...
ання
                    ...
                    if (helper.contains("<"+args[0])) {


                        helper2 = str.substring(str.indexOf("<"+args[0]),str.indexOf("</b></"+args[0]+">")+11);

                        allTags.add(helper2);

                        helper2 = helper.substring(helper.indexOf("<"+args[0]), helper.length());

                        allTags.add(helper2);



                        str = str.replace(helper2, "");



                    }
                    else {
                        if(!helper.contains("xml"))
                        {

                            helper = "<"+args[0]+">"+helper;
