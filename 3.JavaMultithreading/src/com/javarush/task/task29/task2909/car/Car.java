...
public abstract class Car {
    ...
    public int getNumberOfPassengersCanBeTransferred() {
        if (canPassengersBeTransferred() == true)
    ...
    {
        winterFuelConsumption = length * winterFuelConsumption + winterWarmingUp;
        return winterFuelConsumption;
    }

    public double getSummerConsumption(int length)
    {
        summerFuelConsumption = length * summerFuelConsumption;
        return summerFuelConsumption;
    }
